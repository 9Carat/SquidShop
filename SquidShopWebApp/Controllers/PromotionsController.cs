...
namespace SquidShopWebApp.Controllers
{
    public class PromotionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PromotionId,StartDate,EndDate,DiscountPercentage,ProductId")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PromotionId,StartDate,EndDate,DiscountPercentage,ProductId")] Promotion promotion)
        {
